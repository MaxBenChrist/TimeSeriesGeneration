...
def MkSg_Map(mapName=None, N=None, s0=None, params=None, eta=None, *args, **kwargs):
    ...
    if 'Chirikov' == mapName:
    ...
    elif 'DissipativeStandard' == mapName:
        ...
        delta = copy(params)
        for i in arange(2, N + eta).reshape(-1):
            x[i] = mod(x[i - 1] + y[i - 1] + dot(delta, cos(
                dot(dot(2, pi), y[i - 1]))), 1)
    ...
    elif 'FreitasStochasticSine' == mapName:
    ...
    elif 'FreitasNonlinearMA' == mapName:
    ...
    elif 'rickerspopulation' == mapName:
